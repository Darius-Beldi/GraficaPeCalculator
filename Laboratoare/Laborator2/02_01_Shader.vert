...
uniform int clickShader;

void main(void)
  {
    if (clickShader == 1) //pe click stanga schimba 
        gl_Position = in_Position * vec4(0.0, 1.0, 1.0, 1.0);
    else    //pe click dreapta revine la pozitia initiala 
