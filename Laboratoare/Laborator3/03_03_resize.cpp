...
void CreateVBO(void)
{
	...
	GLfloat Vertices[] = {
		...
		//Fie a = 20, b = 50
		//x ul pentru fiecare forma sa apartina (0,20)
		...
		20.0f, 10.0f, 0.0f, 0.2f,

		/*
		00.0f, 0.0f, 0.0f, 1.0f,
...
int main(int argc, char* argv[])
{
	...
	glutCreateWindow("Utilizare glm::ortho");		//	Creeaza fereastra de vizualizare, indicand numele acesteia;
