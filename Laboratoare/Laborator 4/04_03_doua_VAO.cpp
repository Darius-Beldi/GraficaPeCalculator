...
// ================================================
// | Laboratorul IV - 04_03_douaVAO.cpp |
// ======================================
// 
//	Program ce deseneaza doua figuri geometrice;
//	ELEMENTE DE NOUTATE:
...
void CreateVAO1(void)
{
	...
	glGenBuffers(1, &EboId1);														//  Generarea bufferului si indexarea acestuia catre variabila EboId1;
...
void RenderFunction(void)
{
	...
	glDrawElements(GL_TRIANGLES, 9, GL_UNSIGNED_INT, (void*)(0));       // Functia de desenare;
	...
	//glDrawElements(GL_LINE_LOOP, 3, GL_UNSIGNED_INT, (void*)(0));       // Functia de desenare;
