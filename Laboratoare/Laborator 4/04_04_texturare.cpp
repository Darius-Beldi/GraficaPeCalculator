...
// ========================================
// 
//	Program ce deseneaza un patrat, caruia i se aplica o textura;
//	ELEMENTE DE NOUTATE:
...
{
	glClearColor(0.53f, 0.81f, 0.93f, 1.0f);		//  Culoarea de fond a ecranului;
...
{	
	...
	//	Matricea pentru redimensionarea ferestrei + deplasare;
	myMatrix = resizeMatrix * matrTransl * matrRot;
...
int main(int argc, char* argv[])
{
	...
	glutCreateWindow("Utilizarea texturilor");		                //	Creeaza fereastra de vizualizare, indicand numele acesteia;
